...
drop trigger if exists trg_stamp_orders_updated_at on public.stamp_orders;
create trigger trg_stamp_orders_updated_at before update on public.stamp_orders
for each row execute function public.set_updated_at();

drop trigger if exists trg_stamp_batches_updated_at on public.stamp_batches;
create trigger trg_stamp_batches_updated_at before update on public.stamp_batches
for each row execute function public.set_updated_at();
