...
import { AgencyContactsPage } from './pages/AgencyContactsPage';
...
export function App() {
  ...
  function renderPage() {
    switch (currentPage) {
      ...
      case 'serviceStations': return <AgencyContactsPage serviceStations={data.serviceStations} taskForces={data.taskForces} />;
      case 'taskForces': return <AgencyContactsPage serviceStations={data.serviceStations} taskForces={data.taskForces} />;
