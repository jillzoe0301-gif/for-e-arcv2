...
function brokerToneClass(name: string | undefined) {
  if (name?.includes('灃康')) return 'broker-tone-fengkang';
  if (name?.includes('乾坤')) return 'broker-tone-qiankun';
  if (name?.includes('灃禾')) return 'broker-tone-fenghe';
  return 'broker-tone-default';
}
